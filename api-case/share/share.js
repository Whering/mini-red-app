Page({
  onShareAppMessage() {
    if (this.data.promise) {
      ...
      return { ...this.data.shareData, promise };
    }
  ...
  handleTitle(e) {
    this.setData({
      shareData: { ...this.data.shareData, title: e.detail.value },
    });
  },

  handleImageUrl(e) {
    this.setData({
      shareData: { ...this.data.shareData, imageUrl: e.detail.value },
    });
  },

  handlePromise(e) {
    this.setData({ promise: e.detail.value });
  },
});
