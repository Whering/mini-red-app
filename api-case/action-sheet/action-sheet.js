Page({
  ...
  handleAlertText(e) {
    this.setData({ alertText: e.detail.value });
  },

  handleItemColor(e) {
    this.setData({ itemColor: e.detail.value });
  },

  handleItemListLength(e) {
    this.setData({ itemListLength: e.detail.value });
  },
  ...
  actionSheetTap() {
    this.common({ itemList: this.itemList() });
  },
